...
<div>
    ...
    <p>Điểm loyalty được tính từ dữ liệu CRM của khách hàng, chưa bắt buộc phải có dữ liệu Sales/Invoicing.</p>
    <ul>
    ...
    <p>Giai đoạn mở rộng có thể liên kết thêm Sales/Invoicing để tính doanh thu thực tế và giá trị vòng đời khách hàng.</p>
</div>
"""
...
<div>
    ...
    <p><b>Gợi ý nhanh:</b> VIP/Vàng ưu tiên chăm sóc nhanh và tri ân; Bạc ưu tiên follow-up báo giá; Tiêu chuẩn tập trung tư vấn nhu cầu và nuôi dưỡng lead.</p>
</div>
"""
...
class ResPartner(models.Model):
    ...
    crm_estimated_revenue = fields.Monetary(
        ...
        help="Giá trị dự kiến do bộ phận CRM/Sales ghi nhận, dùng khi chưa tích hợp Sales/Invoicing.",
    )
